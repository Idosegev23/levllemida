...
const UniqueHeroSection = () => {
  ...
  return (
    <section className="min-h-screen relative overflow-hidden bg-neutral">
      {/* רקע דינמי עדין */}
      <div 
        className="absolute inset-0 opacity-30"
        style={{
          background: `radial-gradient(circle at ${mousePos.x}% ${mousePos.y}%, rgba(124, 152, 133, 0.1) 0%, transparent 50%)`
        }}
      />
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 pt-20 sm:pt-24">
          ...
          <div className="grid grid-cols-12 gap-4 sm:gap-6 lg:gap-8 items-center">
            ...
            <div className="col-span-12 lg:col-span-7 order-1">
              ...
              >
                ...
                <motion.h1 
                  className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl font-black leading-tight text-text-dark relative z-10"
            ...
            <div className="col-span-12 lg:col-span-5 flex justify-center lg:justify-end order-2 lg:order-2 mt-8 lg:mt-0">
              <motion.div
                ...
                className="relative"
              >
                <div className="w-48 h-48 sm:w-56 sm:h-56 lg:w-64 lg:h-64 bg-gradient-to-br from-accent/20 to-primary/20 rounded-[40px] sm:rounded-[50px] lg:rounded-[60px] rotate-12 relative overflow-hidden">
          ...
          <div className="mt-12 sm:mt-16 lg:mt-20 grid grid-cols-12 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="col-span-12 lg:col-span-6">
              ...
              >
                ...
                <p className="text-lg sm:text-xl lg:text-2xl leading-relaxed text-text-light font-medium">
                ...
                <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-warm/20 rounded-full flex items-center justify-center flex-shrink-0">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-warm rounded-full"></div>
                  </div>
          ...
          <div className="mt-12 sm:mt-16 lg:mt-20 grid grid-cols-12 gap-4 sm:gap-6 lg:gap-8">
              ...
              >
                <Link href="#צור-קשר">
                  ...
                  >
                    ...
                    {/* אפקט הדגשה */}
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-r from-warm to-primary"
                      initial={{ x: "-100%" }}
                      whileHover={{ x: 0 }}
            ...
            <div className="col-span-12 lg:col-span-8 flex items-center justify-center lg:items-end">
              ...
              >
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-2 sm:gap-3 text-text-light">
                  <div className="w-8 h-px bg-text-light/30 hidden sm:block"></div>
